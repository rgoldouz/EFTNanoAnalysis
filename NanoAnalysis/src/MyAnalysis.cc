...
void MyAnalysis::Loop(TString fname, TString data, TString dataset ,string year, TString run, float xs, float lumi, float Nevent, int iseft, int nRuns){
  ...
  string bSF="";
  if(year == "2016preVFP"){
    eleSF="/afs/crc.nd.edu/user/r/rgoldouz/BNV/NanoAnalysis/data/POG/EGM/2016preVFP_UL/electron.json";
    muSF= "/afs/crc.nd.edu/user/r/rgoldouz/BNV/NanoAnalysis/data/POG/MUO/2016preVFP_UL/muon_Z.json";
    bSF="/afs/crc.nd.edu/user/r/rgoldouz/BNV/NanoAnalysis/data/POG/BTV/2016preVFP_UL/btagging.json";
  }
  if(year == "2016postVFP"){
    eleSF="/afs/crc.nd.edu/user/r/rgoldouz/BNV/NanoAnalysis/data/POG/EGM/2016postVFP_UL/electron.json";
    muSF= "/afs/crc.nd.edu/user/r/rgoldouz/BNV/NanoAnalysis/data/POG/MUO/2016postVFP_UL/muon_Z.json";
    bSF="/afs/crc.nd.edu/user/r/rgoldouz/BNV/NanoAnalysis/data/POG/BTV/2016postVFP_UL/btagging.json";
  }
  if(year == "2017"){
  ...
  if(year == "2018"){
    eleSF="/afs/crc.nd.edu/user/r/rgoldouz/BNV/NanoAnalysis/data/POG/EGM/2018_UL/electron.json";
    muSF= "/afs/crc.nd.edu/user/r/rgoldouz/BNV/NanoAnalysis/data/POG/MUO/2018_UL/muon_Z.json";
    bSF="/afs/crc.nd.edu/user/r/rgoldouz/BNV/NanoAnalysis/data/POG/BTV/2018_UL/btagging.json";
  }
  ...
  std::vector<TString> sys{"eleRecoSf", "eleIDSf", "muIdSf", "muIsoSf", "bcTagSF", "udsgTagSF","pu", "prefiring", "trigSF","jes", "jer","muonScale","electronScale","muonRes" };
  ...
  if(data == "mc"){
    if (fname.Contains("TTTo2L2Nu") || fname.Contains("BNVFix")){
      for (int i=0;i<channels.size();++i){
        for (int k=2;k<regions.size();++k){
        for( auto it = vars.cbegin() ; it != vars.cend() ; ++it ){
            if(it->first !="BDT") continue;
  ...
  readerMVA->BookMVA( "BDT", "/afs/crc.nd.edu/user/r/rgoldouz/BNV/NanoAnalysis/input/TMVAClassification_BDT.weights.xml");
  ...
  if (fname.Contains("TTTo2L2Nu") || fname.Contains("TTsys") || fname.Contains("BNV_TT")) ifTopPt=true;
  if (fChain == 0) return;
...
//cout<<nLHEPdfWeight<<"-"<<nLHEScaleWeight<<"-"<<nPSWeight<<endl;
...
// Muon selection
    for (int l=0;l<nMuon;l++){
      ...
      if (data == "mc") {
        ...
        nominalWeights[2] = nominalWeights[2] * csetMuHighPtId->evaluate({year + "_UL", abs(Muon_eta[l]),  Muon_pt[l], "sf"});
        sysUpWeights[2] = sysUpWeights[2] * csetMuHighPtId->evaluate({year + "_UL", abs(Muon_eta[l]),  Muon_pt[l], "systup"});
        sysDownWeights[2] = sysDownWeights[2] * csetMuHighPtId->evaluate({year + "_UL", abs(Muon_eta[l]),  Muon_pt[l], "systdown"});

        sf_Mu_ISO = sf_Mu_ISO * csetMuHighPtIso->evaluate({year + "_UL", abs(Muon_eta[l]),  Muon_pt[l], "sf"});
        nominalWeights[3] = nominalWeights[3] * csetMuHighPtIso->evaluate({year + "_UL", abs(Muon_eta[l]),  Muon_pt[l], "sf"});
        sysUpWeights[3] = sysUpWeights[3] * csetMuHighPtIso->evaluate({year + "_UL", abs(Muon_eta[l]),  Muon_pt[l], "systup"});
        sysDownWeights[3] = sysDownWeights[3] * csetMuHighPtIso->evaluate({year + "_UL", abs(Muon_eta[l]),  Muon_pt[l], "systdown"});
      }
    }
...
//jets
    ...
    for (int l=0;l<nJet;l++){
      ...
      if(data == "mc" && abs(Jet_eta[l]) < 2.4){
        if(Jet_pt_nom[l] >30) selectedJets->push_back(new jet_candidate(Jet_pt_nom[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));

        if(Jet_pt_jer0Up[l]>30 && abs(Jet_pt_jer0Up[l]-Jet_pt_nom[l])>0) selectedJetsJerUp->push_back(new jet_candidate(Jet_pt_jer0Up[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jer1Up[l]>30 && abs(Jet_pt_jer1Up[l]-Jet_pt_nom[l])>0) selectedJetsJerUp->push_back(new jet_candidate(Jet_pt_jer1Up[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jer2Up[l]>30 && abs(Jet_pt_jer2Up[l]-Jet_pt_nom[l])>0) selectedJetsJerUp->push_back(new jet_candidate(Jet_pt_jer2Up[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jer3Up[l]>30 && abs(Jet_pt_jer3Up[l]-Jet_pt_nom[l])>0) selectedJetsJerUp->push_back(new jet_candidate(Jet_pt_jer3Up[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jer4Up[l]>30 && abs(Jet_pt_jer4Up[l]-Jet_pt_nom[l])>0) selectedJetsJerUp->push_back(new jet_candidate(Jet_pt_jer4Up[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jer5Up[l]>30 && abs(Jet_pt_jer5Up[l]-Jet_pt_nom[l])>0) selectedJetsJerUp->push_back(new jet_candidate(Jet_pt_jer5Up[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));

        if(Jet_pt_jer0Down[l]>30 && abs(Jet_pt_jer0Down[l]-Jet_pt_nom[l])>0) selectedJetsJerDown->push_back(new jet_candidate(Jet_pt_jer0Down[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jer1Down[l]>30 && abs(Jet_pt_jer1Down[l]-Jet_pt_nom[l])>0) selectedJetsJerDown->push_back(new jet_candidate(Jet_pt_jer1Down[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jer2Down[l]>30 && abs(Jet_pt_jer2Down[l]-Jet_pt_nom[l])>0) selectedJetsJerDown->push_back(new jet_candidate(Jet_pt_jer2Down[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jer3Down[l]>30 && abs(Jet_pt_jer3Down[l]-Jet_pt_nom[l])>0) selectedJetsJerDown->push_back(new jet_candidate(Jet_pt_jer3Down[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jer4Down[l]>30 && abs(Jet_pt_jer4Down[l]-Jet_pt_nom[l])>0) selectedJetsJerDown->push_back(new jet_candidate(Jet_pt_jer4Down[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jer5Down[l]>30 && abs(Jet_pt_jer5Down[l]-Jet_pt_nom[l])>0) selectedJetsJerDown->push_back(new jet_candidate(Jet_pt_jer5Down[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));

        if(Jet_pt_jesTotalUp[l] >30) selectedJetsJesUp->push_back(new jet_candidate(Jet_pt_jesTotalUp[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        if(Jet_pt_jesTotalDown[l] >30) selectedJetsJesDown->push_back(new jet_candidate(Jet_pt_jesTotalDown[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
      }
      if(data == "data" && Jet_pt_nom[l] >30 && abs(Jet_eta[l]) < 2.4){
        selectedJets->push_back(new jet_candidate(Jet_pt_nom[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l],year,0));
        selectedJetsJerUp->push_back(new jet_candidate(Jet_pt_nom[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l],year,0));
        selectedJetsJerDown->push_back(new jet_candidate(Jet_pt_nom[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l],year,0));
        selectedJetsJesUp->push_back(new jet_candidate(Jet_pt_nom[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l],year,0));
        selectedJetsJesDown->push_back(new jet_candidate(Jet_pt_nom[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l],year,0));
      }
    }
      ...
      for (int n=0;n<sysJecNames.size();++n){
        ...
        for (int l=0;l<nJet;l++){
          ...
          if ((1+sup)*Jet_pt[l]>30) {
            JECJetsUp->push_back(new jet_candidate((1+sup)*Jet_pt_nom[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
          ...
          if ((1-sdw)*Jet_pt_nom[l]>30){
            JECJetsDown->push_back(new jet_candidate((1-sdw)*Jet_pt_nom[l],Jet_eta[l],Jet_phi[l],Jet_mass[l],Jet_btagDeepB[l], year,Jet_partonFlavour[l]));
        ...
        JECsysMETUp->push_back(sqrt(pow(MET_T1_pt * cos(MET_phi) - JECMETUpx,2)+pow(MET_T1_pt * sin(MET_T1_phi) - JECMETUpy,2)));
        JECsysMETDown->push_back(sqrt(pow(MET_T1_pt * cos(MET_phi) - JECMETDownx,2)+pow(MET_T1_pt * sin(MET_T1_phi) - JECMETDowny,2)));
      }
    ...
    for (int l=0;l<selectedJets->size();l++){
      ...
      if( abs((*selectedJets)[l]->flavor_) == 5){
        ...
        if( (*selectedJets)[l]->btag_ ) {
          ...
          nominalWeights[4] = nominalWeights[4] * scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysUpWeights[4] = sysUpWeights[4] * scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"up", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysDownWeights[4] = sysDownWeights[4] * scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"down", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});

         nominalWeights[5] = nominalWeights[5] * scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysUpWeights[5] = sysUpWeights[5] * scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysDownWeights[5] = sysDownWeights[5] * scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
        }
        if( !(*selectedJets)[l]->btag_ ) {
          ...
          nominalWeights[4] = nominalWeights[4]* (1- (scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysUpWeights[4] = sysUpWeights[4]* (1- (scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"up", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysDownWeights[4] = sysDownWeights[4]* (1- (scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"down", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));

          nominalWeights[5] = nominalWeights[5]* (1- (scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysUpWeights[5] = sysUpWeights[5]* (1- (scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysDownWeights[5] = sysDownWeights[5]* (1- (scale_factor(&btagEff_b_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 5, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
        }
      }
      if( abs((*selectedJets)[l]->flavor_) == 4){
        ...
        if( (*selectedJets)[l]->btag_) {
          ...
          nominalWeights[4] = nominalWeights[4] * scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysUpWeights[4] = sysUpWeights[4] * scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"up", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysDownWeights[4] = sysDownWeights[4] * scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"down", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});

          nominalWeights[5] = nominalWeights[5] * scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysUpWeights[5] = sysUpWeights[5] * scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"up", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysDownWeights[5] = sysDownWeights[5] * scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"down", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
        }
        if( !(*selectedJets)[l]->btag_ ) {
          ...
          nominalWeights[4] = nominalWeights[4]* (1- (scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysUpWeights[4] = sysUpWeights[4]* (1- (scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"up", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysDownWeights[4] = sysDownWeights[4]* (1- (scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"down", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));

          nominalWeights[5] = nominalWeights[5]* (1- (scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysUpWeights[5] = sysUpWeights[5]* (1- (scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysDownWeights[5] = sysDownWeights[5]* (1- (scale_factor(&btagEff_c_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetBcJetSF->evaluate({"central", "M", 4, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
        }
      }
      ...
      if( abs((*selectedJets)[l]->flavor_) != 4 && abs((*selectedJets)[l]->flavor_) != 5){
        ...
        if( (*selectedJets)[l]->btag_) {
          ...
          nominalWeights[4] = nominalWeights[4]* scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"central", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysUpWeights[4] = sysUpWeights[4]* scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"central", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysDownWeights[4] = sysDownWeights[4]* scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"central", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});

          nominalWeights[5] = nominalWeights[5] * scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"central", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysUpWeights[5] = sysUpWeights[5] * scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"up", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
          sysDownWeights[5] = sysDownWeights[5] * scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"down", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_});
        }
        if( !(*selectedJets)[l]->btag_ ) {
          ...
          nominalWeights[4] = nominalWeights[4]* (1- (scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"central", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysUpWeights[4] = sysUpWeights[4]* (1- (scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"central", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysDownWeights[4] = sysDownWeights[4]* (1- (scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"central", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));

          nominalWeights[5] = nominalWeights[5]* (1- (scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"central", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysUpWeights[5] = sysUpWeights[5]* (1- (scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"up", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
          sysDownWeights[5] = sysDownWeights[5]* (1- (scale_factor(&btagEff_udsg_H, (*selectedJets)[l]->pt_, abs((*selectedJets)[l]->eta_),"central", true, false) * csetLightJetSF->evaluate({"down", "M", 0, abs((*selectedJets)[l]->eta_),(*selectedJets)[l]->pt_})));
        }
      }
    }
...
//PU reweighting
    ...
    if (data == "mc" && (year == "2016preVFP" || year == "2016postVFP" || year == "2017")) {
    ...
    if (fname.Contains("BNV_TT")) weight_topPtPowheg = weight_topPtMGLO;
...
//Fill histograms
    if(leptonPass && triggerPass){
      ...
      if (data == "mc") weight_lep  = weight_Lumi * signnum_typical(LHEWeight_originalXWGTUP) * sf_Ele_Reco * sf_Ele_ID * sf_Mu_ID * sf_Mu_ISO * sf_Trigger * weight_PU * weight_prefiring * weight_topPtPowheg;
      if (data == "mc") weight_lepB = weight_Lumi * signnum_typical(LHEWeight_originalXWGTUP) * sf_Ele_Reco * sf_Ele_ID * sf_Mu_ID * sf_Mu_ISO * sf_Trigger * weight_PU * weight_prefiring * weight_topPtPowheg * (P_bjet_data/P_bjet_mc);
      if (data == "mc") weight_EFT = (1000.0/nRuns)  * sf_Ele_Reco * sf_Ele_ID * sf_Mu_ID * sf_Mu_ISO* (P_bjet_data/P_bjet_mc) * sf_Trigger * weight_PU * weight_prefiring * weight_topPtPowheg;
...
//cout<<"sf_Ele_Reco:"<<sf_Ele_Reco<<" sf_Ele_ID:"<<sf_Ele_ID<<" sf_Mu_ID:"<<sf_Mu_ID<<" sf_Mu_ISO:"<<sf_Mu_ISO<<" sf_Trigger:"<<sf_Trigger<<" weight_PU:"<<weight_PU<<" weight_prefiring:"<<weight_prefiring<< " weight_topPtPowheg:"<<weight_topPtPowheg<<endl;
      ...
      Hists[ch][0][15]->Fill(MET_pt,weight_lep, *eft_fit);
      Hists[ch][0][16]->Fill(MET_phi,weight_lep, *eft_fit);
      ...
      if (DyPass){
        ...
        Hists[ch][1][15]->Fill(MET_pt,weight_lep, *eft_fit);
        Hists[ch][1][16]->Fill(MET_phi,weight_lep, *eft_fit);
      ...
      if(nbjet==1 && DyPass){
        ...
        recoNu = Wneutrino(MET_pt, MET_phi, (*selectedLeptons)[1]->pt_, (*selectedLeptons)[1]->eta_, (*selectedLeptons)[1]->phi_);
        recoW = recoNu + recoL2;
        ...
        MVAoutput = readerMVA->EvaluateMVA( "BDT");
        ...
        Hists[ch][2][15]->Fill(MET_pt,weight_lepB, *eft_fit);
        Hists[ch][2][16]->Fill(MET_phi,weight_lepB, *eft_fit);
      ...
      if(nbjet>1 && DyPass){
        ...
        Hists[ch][3][15]->Fill(MET_pt,weight_lepB, *eft_fit);
        Hists[ch][3][16]->Fill(MET_phi,weight_lepB, *eft_fit);
      ...
      if (data == "mc") {
        if(nbjet==1 && DyPass){
          for (int n=0;n<9;++n){
            ...
            HistsSysUp[ch][2][15][n]->Fill(MET_pt,weight_lepB * (sysUpWeights[n]/nominalWeights[n]), *eft_fit);
            HistsSysUp[ch][2][16][n]->Fill(MET_phi,weight_lepB * (sysUpWeights[n]/nominalWeights[n]), *eft_fit);
            ...
            HistsSysDown[ch][2][15][n]->Fill(MET_pt,weight_lepB * (sysDownWeights[n]/nominalWeights[n]), *eft_fit);
            HistsSysDown[ch][2][16][n]->Fill(MET_phi,weight_lepB * (sysDownWeights[n]/nominalWeights[n]), *eft_fit);
        ...
        if(nbjetJesUp ==1 && DyPass) {
          ...
          HistsSysUp[ch][2][15][9]->Fill(MET_pt,weight_lepB , *eft_fit);
          HistsSysUp[ch][2][16][9]->Fill(MET_phi,weight_lepB , *eft_fit);
        ...
        if(nbjetJesDown==1 && DyPass){ 
          ...
          HistsSysDown[ch][2][15][9]->Fill(MET_pt,weight_lepB , *eft_fit);
          HistsSysDown[ch][2][16][9]->Fill(MET_phi,weight_lepB , *eft_fit);
        ...
        if(nbjetJerUp ==1 && DyPass) {
          ...
          HistsSysUp[ch][2][15][10]->Fill(MET_pt,weight_lepB , *eft_fit);
          HistsSysUp[ch][2][16][10]->Fill(MET_phi,weight_lepB , *eft_fit);
        ...
        if(nbjetJerDown==1 && DyPass){
          ...
          HistsSysDown[ch][2][15][10]->Fill(MET_pt,weight_lepB , *eft_fit);
          HistsSysDown[ch][2][16][10]->Fill(MET_phi,weight_lepB , *eft_fit);
...
//New Region 
        if(nbjet>1 && DyPass){
          for (int n=0;n<9;++n){
            ...
            HistsSysUp[ch][3][15][n]->Fill(MET_pt,weight_lepB * (sysUpWeights[n]/nominalWeights[n]), *eft_fit);
            HistsSysUp[ch][3][16][n]->Fill(MET_phi,weight_lepB * (sysUpWeights[n]/nominalWeights[n]), *eft_fit);
            ...
            HistsSysDown[ch][3][15][n]->Fill(MET_pt,weight_lepB * (sysDownWeights[n]/nominalWeights[n]), *eft_fit);
            HistsSysDown[ch][3][16][n]->Fill(MET_phi,weight_lepB * (sysDownWeights[n]/nominalWeights[n]), *eft_fit);
...
//Jes unc
        if(nbjetJesUp >1 && DyPass) {
          ...
          HistsSysUp[ch][3][15][9]->Fill(MET_pt,weight_lepB , *eft_fit);
          HistsSysUp[ch][3][16][9]->Fill(MET_phi,weight_lepB , *eft_fit);
        ...
        if(nbjetJesDown>1 && DyPass){ 
          ...
          HistsSysDown[ch][3][15][9]->Fill(MET_pt,weight_lepB , *eft_fit);
          HistsSysDown[ch][3][16][9]->Fill(MET_phi,weight_lepB , *eft_fit);
        ...
        if(nbjetJerUp >1 && DyPass) {
          ...
          HistsSysUp[ch][3][15][10]->Fill(MET_pt,weight_lepB , *eft_fit);
          HistsSysUp[ch][3][16][10]->Fill(MET_phi,weight_lepB , *eft_fit);
        ...
        if(nbjetJerDown>1 && DyPass){
          ...
          HistsSysDown[ch][3][15][10]->Fill(MET_pt,weight_lepB , *eft_fit);
          HistsSysDown[ch][3][16][10]->Fill(MET_phi,weight_lepB , *eft_fit);
...
// Lepton scale resolution uncertainties
    if (data == "mc"){
      ...
      if(leptonPass && triggerPass){
        weight_lepB = weight_Lumi * signnum_typical(LHEWeight_originalXWGTUP) * sf_Ele_Reco * sf_Ele_ID * sf_Mu_ID * sf_Mu_ISO* (P_bjet_data/P_bjet_mc) * sf_Trigger * weight_PU * weight_prefiring * weight_topPtPowheg;
        weight_EFT = (1000.0/nRuns)  * sf_Ele_Reco * sf_Ele_ID * sf_Mu_ID * sf_Mu_ISO* (P_bjet_data/P_bjet_mc) * sf_Trigger * weight_PU * weight_prefiring * weight_topPtPowheg;
        if (iseft) eft_fit = new WCFit(nWCnames, wc_names_lst, nEFTfitCoefficients, EFTfitCoefficients, weight_EFT);
        else eft_fit = new WCFit(0,wc_names_lst,1, &genWeight, 1.0);
        if(nbjet==1 && DyPass){
          ...
          recoNu = Wneutrino(MET_pt, MET_phi, (*selectedLeptonsMuScaleUp)[1]->pt_, (*selectedLeptonsMuScaleUp)[1]->eta_, (*selectedLeptonsMuScaleUp)[1]->phi_);
          recoW = recoNu + recoL2;
          recoTop = recoW + recoBjet;
          ...
          HistsSysUp[ch][2][15][11]->Fill(MET_pt,weight_lepB, *eft_fit);
          HistsSysUp[ch][2][16][11]->Fill(MET_phi,weight_lepB, *eft_fit);
        ...
        if(nbjet>1 && DyPass){
          ...
          HistsSysUp[ch][3][15][11]->Fill(MET_pt,weight_lepB, *eft_fit);
          HistsSysUp[ch][3][16][11]->Fill(MET_phi,weight_lepB, *eft_fit);
      ...
      if(leptonPass && triggerPass){
        ...
        if(nbjet==1 && DyPass){
          ...
          recoNu = Wneutrino(MET_pt, MET_phi, (*selectedLeptonsMuScaleDown)[1]->pt_, (*selectedLeptonsMuScaleDown)[1]->eta_, (*selectedLeptonsMuScaleDown)[1]->phi_);
          recoW = recoNu + recoL2;
          recoTop = recoW + recoBjet;
          ...
          HistsSysDown[ch][2][15][11]->Fill(MET_pt,weight_lepB, *eft_fit);
          HistsSysDown[ch][2][16][11]->Fill(MET_phi,weight_lepB, *eft_fit);
        ...
        if(nbjet>1 && DyPass){
          ...
          HistsSysDown[ch][3][15][11]->Fill(MET_pt,weight_lepB, *eft_fit);
          HistsSysDown[ch][3][16][11]->Fill(MET_phi,weight_lepB, *eft_fit);
      ...
      if(leptonPass && triggerPass){
        ...
        if(nbjet==1 && DyPass){
          ...
          recoNu = Wneutrino(MET_pt, MET_phi, (*selectedLeptonsEleScaleUp)[1]->pt_, (*selectedLeptonsEleScaleUp)[1]->eta_, (*selectedLeptonsEleScaleUp)[1]->phi_);
          recoW = recoNu + recoL2;
          recoTop = recoW + recoBjet;
          ...
          HistsSysUp[ch][2][15][12]->Fill(MET_pt,weight_lepB, *eft_fit);
          HistsSysUp[ch][2][16][12]->Fill(MET_phi,weight_lepB, *eft_fit);
        ...
        if(nbjet>1 && DyPass){
          ...
          HistsSysUp[ch][3][15][12]->Fill(MET_pt,weight_lepB, *eft_fit);
          HistsSysUp[ch][3][16][12]->Fill(MET_phi,weight_lepB, *eft_fit);
      ...
      if(leptonPass && triggerPass){
        ...
        if(nbjet==1 && DyPass){
          ...
          recoNu = Wneutrino(MET_pt, MET_phi, (*selectedLeptonsEleScaleDown)[1]->pt_, (*selectedLeptonsEleScaleDown)[1]->eta_, (*selectedLeptonsEleScaleDown)[1]->phi_);
          recoW = recoNu + recoL2;
          recoTop = recoW + recoBjet;
          ...
          HistsSysDown[ch][2][15][12]->Fill(MET_pt,weight_lepB, *eft_fit);
          HistsSysDown[ch][2][16][12]->Fill(MET_phi,weight_lepB, *eft_fit);
        ...
        if(nbjet>1 && DyPass){
          ...
          HistsSysDown[ch][3][15][12]->Fill(MET_pt,weight_lepB, *eft_fit);
          HistsSysDown[ch][3][16][12]->Fill(MET_phi,weight_lepB, *eft_fit);
      ...
      if(leptonPass && triggerPass){
        ...
        if(nbjet==1 && DyPass){
          ...
          recoNu = Wneutrino(MET_pt, MET_phi, (*selectedLeptonsMuResUp)[1]->pt_, (*selectedLeptonsMuResUp)[1]->eta_, (*selectedLeptonsMuResUp)[1]->phi_);
          recoW = recoNu + recoL2;
          recoTop = recoW + recoBjet;
          ...
          HistsSysUp[ch][2][15][13]->Fill(MET_pt,weight_lepB, *eft_fit);
          HistsSysUp[ch][2][16][13]->Fill(MET_phi,weight_lepB, *eft_fit);
        ...
        if(nbjet>1 && DyPass){
          ...
          HistsSysUp[ch][3][15][13]->Fill(MET_pt,weight_lepB, *eft_fit);
          HistsSysUp[ch][3][16][13]->Fill(MET_phi,weight_lepB, *eft_fit);
