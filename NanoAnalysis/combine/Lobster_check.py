...
rmax= 3000.0 / (200*theoryXS[quark.index(val[1][1:3])][Couplings.index(val[0])])
rmin = -1 * rmax
...
os.system('combineTool.py -M Impacts -d '         +val[0] +'_'+val[1]+'_'+val[2] + '_com.root -m 125 --robustFit 1 --doFits --parallel 8 --rMin -3 --rMax 3 -t -1 --expectSignal=1 --parallel 8')
...
os.system('mv impacts.pdf ' + val[0] +'_'+val[1]+'_'+val[2] + '_Expected_mu1_impacts.pdf')
...
os.system('combineTool.py -M Impacts -d '         +val[0] +'_'+val[1]+'_'+val[2] + '_com.root -m 125 --robustFit 1 --doFits --parallel 8 --rMin -3 --rMax 3 -t -1 --expectSignal=0 --parallel 8')
...
if len(Y)==1:
    ...
    os.system('plotImpacts.py -i impacts.json -o impacts --max-pages 1 --label-size 0.03 --cms-label ,' + val[0] +'_'+val[1]+'_2016-2018')
os.system('mv impacts.pdf ' + val[0] +'_'+val[1]+'_'+val[2] + '_Expected_mu0_impacts.pdf')

#Observed impact plot
os.system('combineTool.py -M Impacts -d '         +val[0] +'_'+val[1]+'_'+val[2] + '_com.root -m 125 --doInitialFit --robustFit 1  --rMin ' + str(rmin) + ' --rMax ' + str(rmax))
os.system('combineTool.py -M Impacts -d '         +val[0] +'_'+val[1]+'_'+val[2] + '_com.root -m 125  --doFits --robustFit 1 --parallel 8  --rMin ' + str(rmin) + ' --rMax ' + str(rmax))
os.system('combineTool.py -M Impacts -d '         +val[0] +'_'+val[1]+'_'+val[2] + '_com.root -m 125 -o impacts.json  --rMin ' + str(rmin) + ' --rMax ' + str(rmax))
if len(Y)==1:
